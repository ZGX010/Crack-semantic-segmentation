...
**Result:** The proposed NB-CNN achieves 98.3% hit rate against 0.1 FPPF that is
much higher than the 82.1% hit rate of LBP-SVM with the same FPPF. The capability of the proposed NB-CNN is a significant
achievement toward autonomous inspection of nuclear power plant internal components <br>
**Link**  
  <br>
---
